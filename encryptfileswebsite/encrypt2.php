    ...
    <header>
        ...
        <div class="main">
            <div class="contnr">
                ...
                <div class="right">
                    <form method="POST" action="enc2end.php" >
                        <label for="foo">Select a file(MAX:500mb):</label>
                        <input type="file" id="foo" name="foo">
                        <div class="btn">
                        <button class="buttonn" type="submit" name="encrypt" value="encrypt">ENCRYPT</button>
                        <button class="buttonn" type="submit" name="decrypt" value="decrypt">DECRYPT</button>
                        </div>
                </form>
                </div>
